import { PrismaClient, RolUsuario, TipoNotificacion } from '@prisma/client';
...
async function main() {
  ...
  // Asegurarnos de limpiar la tabla de configuraciones para re-crearla (siempre ID 1)
  ...
  // MOCK USUARIOS (Para emisor y receptores)
  // Administrador
  ...
  // MOCK NOTIFICACIONES
  // Limpiamos notificaciones previamente creadas por el seed para evitar duplicados en sucesivos runs.

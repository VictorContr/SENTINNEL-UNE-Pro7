 ...
 * @param {string} payload_sm_vc.apellido_sm_vc - Apellido del visitante
 ...
 */
export const enviarContacto_sm_vc = async ({ nombre_sm_vc, apellido_sm_vc, cedula_sm_vc, correo_sm_vc, asunto_sm_vc }) => {

 ...
 *
 * Meta disponibles:
 *   requiresAuth   {Boolean} — requiere JWT válido
 *   roles          {Array}   — roles permitidos ([] = cualquier rol autenticado)
 *   requiresDeploy {Boolean} — FIX #3: requiere puede_hacer_deploy_sm_vc = true
 */
const routes = [
  /* ── PÚBLICA ── */
  {
  ...
  /* ── PRIVADAS ── */
  {
    ...
    children: [
      ...
      {
        // FIX #3: Se agrega requiresDeploy: true
        // El guard en index.js leerá este meta y verificará
        // auth.puede_hacer_deploy_sm_vc antes de permitir el acceso.

<!-- ══════════════════════════════════════════════════════════════════
     DeployPage.vue (admin) — Vista del deploy de un estudiante para Admin.
     Muestra el panel de solo lectura si ya existe deploy.
     Thin Page; delega al pasantiasStore.
     ══════════════════════════════════════════════════════════════════ -->
<template>
  <q-page class="sntnl-page_sm_vc">
    ...
    <div class="page-header_sm_vc">
      ...
      <p class="page-subtitle_sm_vc">
        Vista Administrativa de Estudiante: <span class="code-tag_sm_vc">{{ estudianteId_sm_vc }}</span>
      </p>
    </div>

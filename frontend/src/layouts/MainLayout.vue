    ...
    >
      ...
      <div class="drawer-brand_sm_vc">
        <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
          <polygon points="18,2 34,10 34,26 18,34 2,26 2,10" :stroke="isDark_sm_vc ? '#6fffe9' : '#0d7a6f'" stroke-width="1.5" fill="none"/>
          <polygon points="18,8 28,13 28,23 18,28 8,23 8,13" :stroke="isDark_sm_vc ? '#5bc0be' : '#0e8e82'" stroke-width="0.8" fill="none" opacity="0.5"/>
          <circle cx="18" cy="18" r="4" :fill="isDark_sm_vc ? '#6fffe9' : '#0d7a6f'"/>
        </svg>
        <div>
...
/* ── Theme state (computed desde store) ── */
...
/* ── Computed: rol color (usa variables del tema) ── */
const rol_color_sm_vc = computed(() => {
  ...
  return map_sm_vc[auth.user?.rol_sm_vc] ?? 'var(--sn-acento-sec)'
})
...
.topbar-route-label_sm_vc { display: flex; align-items: center; font-size: 0.72rem; letter-spacing: 0.06em; color: var(--sn-texto-secundario); text-transform: uppercase; }
.route-icon_sm_vc { color: var(--sn-primario); }
.hamburger-btn_sm_vc { color: var(--sn-primario); }
.role-indicator_sm_vc { display: flex; align-items: center; gap: 0.35rem; font-size: 0.6rem; letter-spacing: 0.12em; color: var(--sn-texto-secundario); text-transform: uppercase; padding: 0.2rem 0.6rem; background: var(--sn-surface-alpha); border: 1px solid var(--sn-borde); border-radius: var(--sn-radius-pill); }
...
.dropdown-email_sm_vc { font-size: 0.65rem; color: var(--sn-texto-secundario); margin: 0 0 1px; }
...
.drawer-brand-sub_sm_vc { font-size: 0.48rem; letter-spacing: 0.18em; color: var(--sn-texto-apagado); text-transform: uppercase; margin: 0 0 1px; font-weight: 500; }
.drawer-brand-name_sm_vc { font-size: 1.1rem; font-weight: 700; letter-spacing: 0.2em; color: var(--sn-primario); margin: 0; }
.drawer-version-bar_sm_vc { display: flex; align-items: center; justify-content: space-between; padding: 0.35rem 1rem; font-size: 0.55rem; letter-spacing: 0.1em; color: var(--sn-texto-dim); background: var(--sn-surface-alpha); border-bottom: 1px solid var(--sn-borde); }
.status-dot_sm_vc { width: 5px; height: 5px; border-radius: 50%; background: var(--sn-exito); box-shadow: 0 0 6px var(--sn-exito); animation: pulse-dot_sm_vc 2s infinite; }
...
.nav-section-label_sm_vc { display: flex; align-items: center; font-size: 0.55rem; letter-spacing: 0.18em; text-transform: uppercase; color: var(--sn-texto-dim); padding: 0.75rem 1rem 0.3rem; font-weight: 600; }
.nav-item_sm_vc { padding: 0.3rem 0.75rem; margin: 0.1rem 0.5rem; border-radius: 8px; transition: all 0.15s ease; min-height: 40px; }
.nav-item_sm_vc :deep(.q-item__section--avatar) { min-width: 36px; color: var(--sn-texto-apagado); }
...
.nav-label_sm_vc { font-size: 0.78rem; font-weight: 500; color: var(--sn-texto-secundario); letter-spacing: 0.03em; transition: color 0.15s; }
.nav-caption_sm_vc { font-size: 0.62rem !important; color: var(--sn-texto-dim) !important; margin-top: 1px; }
